...
const en = {
  ...
  "settings.sshHostInfo": "Alias from ~/.ssh/config or user@host — e.g. root@72.62.63.180.",
...
const de: Record<TranslationKey, string> = {
  ...
  "settings.sshHost": "Host",
  "settings.sshHostInfo": "Alias aus ~/.ssh/config oder user@host — z. B. root@72.62.63.180.",
